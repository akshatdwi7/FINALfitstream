      ...
      >
        <div className="absolute inset-0 flex items-center justify-center">
          <div className="text-center text-white px-4">
            <h1 className="text-4xl md:text-6xl font-bold mb-6">Train Together, Grow Together</h1>
            <p className="text-xl md:text-2xl mb-8">Join the world's largest fitness streaming community</p>
      ...
      <div className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-gray-900">Why Choose FitStream?</h2>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center p-6">
              ...
              <p className="text-gray-600">Connect with fitness enthusiasts from around the world</p>
            </div>
            <div className="text-center p-6">
              <div className="flex justify-center mb-4">
              ...
              <p className="text-gray-600">Stream your workouts or join others in real-time</p>
            </div>
            <div className="text-center p-6">
              <div className="flex justify-center mb-4">
              ...
              <div key={item} className="bg-white rounded-lg shadow-md overflow-hidden">
                ...
                <div className="p-4">
                  <div className="flex items-center justify-between mb-2">
                    <span className="text-sm font-semibold text-gray-900">Morning HIIT</span>
                    <span className="bg-red-500 text-white text-xs px-2 py-1 rounded">LIVE</span>
                  </div>
                  <p className="text-sm text-gray-600">Sarah • 1.2k watching</p>
                </div>
              </div>
            ))}
          </div>
